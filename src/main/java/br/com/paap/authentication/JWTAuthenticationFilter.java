...
import static br.com.paap.authentication.SecurityConstants.EXPIRATION_TIME;
import static br.com.paap.authentication.SecurityConstants.HEADER_STRING;
import static br.com.paap.authentication.SecurityConstants.SECRET;
import static br.com.paap.authentication.SecurityConstants.TOKEN_PREFIX;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	{	// Tentar passar os valores que vem do Json para um objeto usuário
		try {
			br.com.paap.model.User usuario = new ObjectMapper().readValue(request.getInputStream(),br.com.paap.model.User.class);
	...
	protected void successfulAuthentication(
		...
		AuthenticationResponseDTO respostaAutenticacao = AuthenticationResponseDTO.builder()
			.id(user.getId())
			.token(bearerToken)
			.role(r)
			.username(username)
